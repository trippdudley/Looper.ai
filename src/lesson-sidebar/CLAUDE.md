# Lesson Sidebar Prototype
The in-lesson copilot. FIXED WIDTH: 420-480px. Dark mode (#0C1117 bg). Shares the coach's
monitor with TrackMan Performance Studio via Windows snap (~75/25 on 1920x1080). Contains
the live lesson timeline with four auto-detected vertical phases (Catch-up → Diagnosis →
