...
export const sessions: Session[] = [
  ...
  },
  {
    ...
    summary: "Built on the weight transfer gains by adding path-specific work with the alignment stick gate. Mike can now hit a draw with both irons and driver \u2014 major milestone. Had one hook when path went too far in-to-out, but he self-corrected. The gate gives him instant feedback on path without needing to look at numbers. Iron contact is significantly more consistent \u2014 7-iron carry averaging 158 (up from 152 at baseline).",
    faults: [
    ...
    notes: "Mike can now hit a draw! This is a huge confidence boost. The combination of weight shift (step drill) and path awareness (gate drill) has transformed his ball flight. He went from a 25-yard slice to a controllable 5-10 yard draw. Next session we'll work on consistency under pressure and start simulating on-course situations. Homework: gate drill at every range session, start with 10 gate reps then hit normal balls.",
  },
  {
    id: "session-5",
    golferId: "golfer-mike",
    ...
    summary: "Today was about owning the changes and developing a stock shot. 8 out of 10 shots were good or better. When one old-pattern fade crept in, Mike recognized it himself and used the step drill feel to reset. His stock driver is now a slight draw, 230-235 carry, with low spin. He hit his best drive ever: 238 carry, 257 total, 1.47 smash factor. Iron work is consistent \u2014 he's gained about 10 yards of carry with the 7-iron since we started.",
    faults: [
    ...
    notes: "This is the session where it all came together. Mike's average driver carry is now 232 vs 219 at baseline \u2014 13 yards gained. His path went from -2.5\u00b0 to +0.3\u00b0. He's not just hitting draws by accident, he understands why. The biggest thing now is taking this to the course. Next session we'll shift to iron work and scoring — driver is in a great place. Arccos data shows his strokes gained off the tee has improved by 0.6 over the last month.",
  },
  {
    id: "session-6",
    golferId: "golfer-mike",
