...
export const C = {
  bg:         '#F6F7F9',   // matches --color-bg-light
  surface:    '#FFFFFF',
  surfaceAlt: '#F0F2F5',
  border:     '#DFE2E7',
  borderSub:  '#ECEEF2',
  ...
  accentHov:    '#0A6352',   // matches --color-accent-light (hover)
  accentBg:     '#E6F5F1',
  accentBright: '#0FA87A',   // matches --color-accent-bright

  ink:   '#1A1F2B',   // matches --color-navy
  body:  '#4B5563',
  muted: '#9CA3AF',
  dim:   '#C5CAD1',

  conf:      '#0FA87A',    // confidence = accent-bright
  confBg:    '#E6F5F1',
...
export const F = {
  ...
  data:  "'Space Mono', Menlo, monospace",
} as const;
