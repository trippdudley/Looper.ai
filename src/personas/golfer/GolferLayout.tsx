...
import { House, BarChart3, Users, Target, Bell, X, MessageSquare } from 'lucide-react';
...
const tabs = [
  ...
  { label: 'Game', icon: <BarChart3 className="w-5 h-5" />, path: '/golfer/game' },
  { label: 'Coach', icon: <Users className="w-5 h-5" />, path: '/golfer/coach' },
  ...
  return (
    <MobileShell>
      ...
      <div className="flex items-center justify-between px-5 py-3">
        <Link to="/" className="text-xl font-bold text-accent-light tracking-tight">Looper</Link>
