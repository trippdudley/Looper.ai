            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="flex gap-4 mt-1">
                  ...
                  <div className="flex flex-col items-center">
                    <div className="w-8 h-8 rounded bg-[#0D7C66]/20 flex items-center justify-center mb-1 border border-[#0D7C66]/40">
                      <span className="text-[8px] font-bold text-[#0D7C66]">FO</span>
                    </div>
                    <span className="text-[9px] text-[#0D7C66]">Face On</span>
                  </div>
                </div>
              </div>
            </div>
