...
const C = {
  ...
  accent:"#0D7C66", accentDim:"#1E3D35",
  teal:"#0FA87A", tealDim:"#134E3A",
  amber:"#D4980B", red:"#C93B3B",
...
function Pill({name}:{name:string}){return <span style={{display:"inline-block",padding:"6px 14px",borderRadius:20,border:`1px solid ${C.dim}`,color:C.muted,fontSize:13,margin:"4px",fontFamily:"'Space Mono',monospace"}}>{name}</span>;}
    ...
    <div style={{background:C.bg,minHeight:"100vh",color:C.text,fontFamily:"DM Sans,system-ui,-apple-system,sans-serif"}}>
      ...
      <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",padding:"0 24px",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{maxWidth:680,position:"relative",zIndex:1}}>
          <div style={{animation:"fadeUp 1s ease-out"}}>
            <div style={{fontSize:12,color:C.accent,letterSpacing:"3px",textTransform:"uppercase",fontWeight:700,marginBottom:28,fontFamily:"'Space Mono',monospace"}}>Thesis</div>
          ...
          <div style={{animation:"fadeUp 1s ease-out 0.7s both"}}>
            <div style={{padding:"22px 24px",borderLeft:`3px solid ${C.accent}`,background:`${C.accentDim}22`,borderRadius:"0 12px 12px 0"}}>
              <p style={{fontSize:20,color:C.accent,fontWeight:700,lineHeight:1.4,fontFamily:"DM Sans,sans-serif",fontStyle:"italic"}}>The question is not whether AI will reshape golf. The question is who builds the infrastructure first.</p>
            </div>
          </div>
        </div>
        ...
        <div style={{textAlign:"center",maxWidth:740,position:"relative",zIndex:1}}>
          ...
          <S delay={0.15}>
            <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:12}}>
              {pillars.slice(0,3).map((p,i) => (
                <div key={i} style={{padding:"20px 14px",borderRadius:12,border:`1px solid ${C.dim}33`,background:`${C.card}88`,textAlign:"left"}}>
                  <div style={{fontSize:28,fontWeight:800,color:p.color,opacity:0.3,marginBottom:6,fontFamily:"'Space Mono',monospace"}}>{p.num}</div>
            ...
            <div style={{marginTop:12,padding:"20px 24px",borderRadius:12,border:`1px solid ${C.dim}33`,background:`${C.card}88`,textAlign:"left",display:"flex",alignItems:"center",gap:20}}>
              <div style={{fontSize:28,fontWeight:800,color:pillars[3].color,opacity:0.3,fontFamily:"'Space Mono',monospace",flexShrink:0}}>{pillars[3].num}</div>
              <div>
      ...
      <div style={{maxWidth:700,margin:"0 auto",padding:"120px 24px"}}>
        ...
        <S delay={0.1}><div style={{padding:"22px 24px",borderLeft:`3px solid ${C.teal}`,background:`${C.tealDim}22`,borderRadius:"0 12px 12px 0"}}>
          <p style={{fontSize:18,color:C.teal,fontWeight:600,fontFamily:"DM Sans,sans-serif",fontStyle:"italic",lineHeight:1.5}}>The missing asset in golf is not more swing data. It is a persistent record of coaching and fitting decisions and outcomes.</p>
        </div></S>
      </div>
            ...
            <S key={i} delay={i*0.07}><div style={{padding:"24px",background:C.card,borderRadius:14,marginBottom:14,border:`1px solid ${C.dim}22`,display:"flex",gap:18,alignItems:"flex-start"}}>
              ...
              <div style={{flex:1}}>
                <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:6,flexWrap:"wrap"}}>
                  ...
                  <span style={{fontSize:10,color:C.teal,letterSpacing:"1px",padding:"2px 8px",border:`1px solid ${C.tealDim}`,borderRadius:4,fontFamily:"'Space Mono',monospace"}}>{item.tag}</span>
                </div>
      ...
      <div style={{maxWidth:700,margin:"0 auto",padding:"120px 24px 80px",textAlign:"center"}}>
        <S>
          ...
          <p style={{fontSize:18,color:C.muted,lineHeight:1.7,maxWidth:520,margin:"0 auto 32px",fontFamily:"DM Sans,sans-serif",fontStyle:"italic"}}>Someone who knows your game, remembers what happened last time, and helps you make better decisions.</p>
