    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <div style={{ background: C.surface, borderRadius: 8, padding: '14px 14px', border: `1px solid ${C.border}` }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
          <div style={{ fontFamily: F.brand, fontSize: 15, fontWeight: 600, color: C.ink, lineHeight: 1.3 }}>
            Dynamic loft variance driving spin spread
          </div>
          <span style={{
            fontFamily: F.data, fontSize: 9, fontWeight: 700, padding: '2px 7px', borderRadius: 3,
            background: C.confBg, color: C.conf, whiteSpace: 'nowrap', marginLeft: 8,
          }}>
            91%
          </span>
        </div>
        <div style={{ fontFamily: F.brand, fontSize: 12, color: C.body, lineHeight: 1.5, marginBottom: 8 }}>
        ...
        {/* Mini strike map — all center, tight cluster */}
